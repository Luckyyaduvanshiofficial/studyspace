...
CREATE TYPE public.booking_status AS ENUM ('CONFIRMED', 'CANCELLED', 'COMPLETED', 'NO_SHOW', 'RELEASED', 'HOLD');

-- Create enum for membership status
CREATE TYPE public.membership_status AS ENUM ('ACTIVE', 'EXPIRED', 'SUSPENDED', 'PENDING');
...
-- Create seat_blocks table for maintenance
...
-- Create wifi_settings table for admin to manage wifi
...
-- RLS Policies for shifts (public read)
